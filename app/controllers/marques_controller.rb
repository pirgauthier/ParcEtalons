class MarquesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @marque.save
        format.html { redirect_to @marque, notice: 'La Marque a été ajoutée avec succès.' }
  ...
  def update
    respond_to do |format|
      if @marque.update(marque_params)
        format.html { redirect_to @marque, notice: 'La Marque a été mise à jour avec succès.' }
  ...
  def destroy
    @marque.destroy
    respond_to do |format|
      format.html { redirect_to marques_url, notice: 'La Marque a été supprimée avec succès.' }
